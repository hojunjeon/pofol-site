...
function renderResume() {
  return `<div class="site-shell resume-shell">${siteHeader("resume")}<main id="main">
    <header class="resume-hero"><div class="resume-hero-main"><img class="resume-profile-photo" src="./public/assets/resume/profile.png" alt="전호준 프로필 사진" width="360" height="480" loading="eager" decoding="async" /><div class="resume-hero-copy"><p class="eyebrow">RESUME · JEON HOJUN</p><h1>전호준</h1><p>AI 시스템·로보틱스·자율주행 프로젝트에서 문제를 나누고 구현과 검증이 이어지는 흐름을 설계했습니다.</p><ul><li>AI Systems</li><li>Robotics</li><li>Autonomous Driving</li></ul></div></div><address><p>Contact</p><a href="mailto:hoj0902@naver.com"><span>Email</span>hoj0902@naver.com</a><a href="tel:+821062893758"><span>Phone</span>010-6289-3758</a><a href="https://github.com/hojunjeon"><span>GitHub</span>github.com/hojunjeon</a></address></header>
    ...
    <section class="resume-section additional-section certification-section" aria-labelledby="certification-title"><div class="resume-section-heading"><span>05</span><h2 id="certification-title">Certifications &amp; Language</h2></div><div class="additional-grid certification-grid"><article class="additional-card certification-card"><p class="card-kicker">자격증</p><h3>SQLD</h3><p>한국데이터산업진흥원 · 2026.03</p><ul class="pill-list" aria-label="SQLD 자격증 정보"><li>한국데이터산업진흥원</li><li>2026.03</li></ul></article><article class="additional-card certification-card"><p class="card-kicker">어학</p><h3>OPIc 영어 IM2</h3><p>2026.03</p><ul class="pill-list" aria-label="OPIc 영어 성적 정보"><li>영어 말하기</li><li>IM2</li><li>2026.03</li></ul></article></div></section>
